            ...
            if nowroutine.text() == "routine " +str(i) :
                ...
                for j in range(len(row)):
                    ...
                    for k in range(goalset):
                        ...
                        if (name =="숄더프레스" or nowrunname == "벤치프레스" or nowrunname == "데드리프트" or nowrunname == "렛풀다운" or nowrunname == "바벨스쿼트"):
                            while True:
                                self.exercount.emit(str(goal2))
    ...
    def run(self): 
        ...
        while True: 
            ...
            if(R_data[2][0] >3):# and R_data[2][0]>30):
                ...
                elif nowrunname == "숄더프레스" or nowrunname == "벤치프레스" or nowrunname == "데드리프트" or nowrunname == "렛풀다운" or nowrunname == "바벨스쿼트":
